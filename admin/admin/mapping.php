                    ...
                    <div class="row">
                            ...
                            <div class="card card-chart">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-category">
                                        <span class="text-success"><i class="fa fa-long-arrow-up"></i> 55% </span>wzrost dzisiejszej sprzedaży.</p>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons">access_time</i> zaktualizowano 4 minuty temu
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-12">
                            <div class="card card-chart">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Subskrypcje Email</h4>
                                    <p class="card-category">Skuteczność ostatniej kampanii</p>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
                                        <i class="material-icons">access_time</i>kampania wysłana 2 dni temu
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-12">
                            <div class="card card-chart">
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Ukończone zadania</h4>
                                    <p class="card-category">Skuteczność ostatniej kampanii</p>
                                </div>
                                <div class="card-footer">
                                    <div class="stats">
