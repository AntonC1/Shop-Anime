...
if (isset($_POST['re_password']))
  ...
  if ($database_password == $op)
    ...
    if ($new_pass == $re_pass)
      ...
      echo "<script>alert('Zaktualizowane Pomyślnie'); </script>";
      }
      else
      {
      echo "<script>alert('Twoje nowe i powtórzone hasła nie są takie same'); </script>";
      }
    }
    else
    {
    echo "<script>alert('Twoje stare hasło jest błędne'); </script>";
    }
  }
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Uzupełnij swój profil</p>
                </div>
                <div class="card-body">
             ...
             <?php endif ?>
                     ...
                     <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">wprowadź stare hasło</label>
                          <input type="text" class="form-control" name="old_pass" id="npwd">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Zmień hasło</label>
                          <input type="text" class="form-control" name="new_pass" id="npwd">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          <label class="bmd-label-floating">Potwierdź Hasło</label>
                          <input type="text" class="form-control" name="re_pass" id="npwd">
                        </div>
                      </div>
               
                    <button class="btn btn-primary pull-right" type="submit" name="re_password">Zaktualizuj Profil</button>
