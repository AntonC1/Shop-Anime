          ...
          <div class="col-md-14">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Zamówienia / Strona <?php echo $page;?> </h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                      <tr><th>Id zamówienia</th><th>Produkty</th><th>Kontakt | Email</th><th>Adres</th><th>Kwota</th><th>Ilość</th>
                    </tr></thead>
                    <tbody>
                      <?php
                     ...
                     echo "<center><h2>Brak dostępnych użytkowników</h2><br><hr></center>";
                     }
                  ?>
                  </table>
