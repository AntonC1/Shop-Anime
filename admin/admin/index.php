                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Imie</th><th>Nazwisko</th><th>Email</th><th>Hasło</th><th>Nr. Telefonu</th><th>Adres</th><th>Miasto</th>
                    </tr></thead>
                    <tbody>
                      <?php 
                        $result=mysqli_query($con,"select * from user_info")or die ("zapytanie niepoprawne");
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Kategoria</th><th>Ilość</th>
                    </tr></thead>
                    <tbody>
                      <?php 
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Marka</th><th>Ilość</th>
                    </tr></thead>
                    <tbody>
                      <?php 
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    ...
                    <tbody>
                      <?php 
                        $result=mysqli_query($con,"select * from email_info")or die ("zapytanie niepoprawne");
                        while(list($brand_id,$brand_title)=mysqli_fetch_array($result))
                        {	
