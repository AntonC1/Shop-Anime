            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="../index.php" class="signup-image-link">Wróć do menu</a>
                    </div>
                    <div class="signin-form">
                        <h2 class="form-title">LOGOWANIE ADMIN</h2>
                        <form  class="register-form" id="login-form" action="login.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" id="your_pass" placeholder="Hasło"/>
                            </div>
                            <div class="form-group form-button">
                                <input type="submit" name="login_admin" id="signin" class="form-submit" value="Zaloguj"/>
                            </div>
                        </form>
                    </div>
                </div>
