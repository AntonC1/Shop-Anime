...
?>
	...
	{
		throw new Error("Okno jest niezdefińowane");
	}
    var _hash = "!";
				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Zł : '.$row['product_price'].'</h3>
								<span class="product-available">Dostępne</span>
							</div>
							<p>------</p>
							...
							<ul class="product-btns">
								<li><a href="#"><i class="fa fa-heart-o"></i> Dodaj do Obserwowanych</a></li>
					...
					<div class="col-md-12">
						<div id="product-tab">
							<ul class="tab-nav">
								...
								<li><a data-toggle="tab" href="#tab2">Detale</a></li>
										...
										<div class="col-md-3 mainn">
											<div id="review-form">
												<form class="review-form">
													<input class="input" type="text" placeholder="Twoje Imie">
													<input class="input" type="email" placeholder="Twój Email">
													...
													<button class="primary-btn">Potwierdź</button>
												</form>
											</div>
										</div>
									</div>
